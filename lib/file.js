...
var File = (function () {
  ...
  File.prototype.isFile = function () {
    return this.exists() && this.filename && typeof this.dir.content[this.filename].content === 'string';
  };

  File.prototype.isDir = function () {
    return this.exists() && (!this.filename || this.dir.content[this.filename].content === 'object');
  };
